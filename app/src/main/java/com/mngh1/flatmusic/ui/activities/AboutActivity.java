...
import com.mngh1.flatmusic.dialogs.ChangelogDialog;
import com.mngh1.flatmusic.dialogs.DonationsDialog;
import com.mngh1.flatmusic.ui.activities.base.AbsBaseActivity;
import com.mngh1.flatmusic.ui.activities.bugreport.BugReportActivity;
    ...
    private void setUpOnClickListeners() {
        moreApp_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent a = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/developer?id=Uranium"));
                startActivity(a);
            }
        });
    }
