package com.mngh1.flatmusic.ui.activities.tageditor;
...
import com.mngh1.flatmusic.glide.palette.BitmapPaletteTranscoder;
import com.mngh1.flatmusic.glide.palette.BitmapPaletteWrapper;
...
import com.mngh1.flatmusic.util.ImageUtil;
import com.mngh1.flatmusic.util.LastFMUtil;
...
public class AlbumTagEditorActivity extends AbsTagEditorActivity implements TextWatcher {
    ...
    protected void deleteImage() {
        setImageBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.art_default_xl), ATHUtil.resolveColor(this, R.attr.defaultFooterColor));
        deleteAlbumArt = true;
        dataChanged();
    }
