...
public class ShowAds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try
        {
            Bitmap bitmap = BitmapFactory.decodeResource(getResources(), com.mngh1.flatmusic.R.drawable.ytinfo);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                setTaskDescription(new ActivityManager.TaskDescription("", bitmap,
                        ContextCompat.getColor(getApplicationContext(), com.mngh1.flatmusic.R.color.text_color_white)));
