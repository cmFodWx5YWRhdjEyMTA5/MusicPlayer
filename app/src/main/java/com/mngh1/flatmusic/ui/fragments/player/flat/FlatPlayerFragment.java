package com.mngh1.flatmusic.ui.fragments.player.flat;
...
import com.mngh1.flatmusic.adapter.song.PlayingQueueAdapter;
import com.mngh1.flatmusic.dialogs.LyricsDialog;
import com.mngh1.flatmusic.dialogs.SongShareDialog;
import com.mngh1.flatmusic.helper.MusicPlayerRemote;
import com.mngh1.flatmusic.helper.menu.SongMenuHelper;
import com.mngh1.flatmusic.model.Song;
import com.mngh1.flatmusic.model.lyrics.Lyrics;
import com.mngh1.flatmusic.ui.activities.base.AbsSlidingMusicPanelActivity;
import com.mngh1.flatmusic.ui.fragments.player.AbsPlayerFragment;
import com.mngh1.flatmusic.ui.fragments.player.PlayerAlbumCoverFragment;
...
import com.mngh1.flatmusic.util.ViewUtil;
import com.mngh1.flatmusic.views.WidthFitSquareLayout;
...
public class FlatPlayerFragment extends AbsPlayerFragment implements SharedPreferences.OnSharedPreferenceChangeListener,PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    ...
    @BindView(R.id.player_panel_content)
    LinearLayout player_panel_content;
