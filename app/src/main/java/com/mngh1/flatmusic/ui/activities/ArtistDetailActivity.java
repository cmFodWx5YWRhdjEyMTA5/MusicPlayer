...
import com.mngh1.flatmusic.adapter.album.HorizontalAlbumAdapter;
import com.mngh1.flatmusic.adapter.song.ArtistSongAdapter;
import com.mngh1.flatmusic.dialogs.AddToPlaylistDialog;
import com.mngh1.flatmusic.dialogs.SleepTimerDialog;
import com.mngh1.flatmusic.glide.ArtistGlideRequest;
import com.mngh1.flatmusic.glide.PhonographColoredTarget;
...
import com.mngh1.flatmusic.interfaces.PaletteColorHolder;
import com.mngh1.flatmusic.lastfm.rest.LastFMRestClient;
import com.mngh1.flatmusic.lastfm.rest.model.LastFmArtist;
import com.mngh1.flatmusic.loader.ArtistLoader;
import com.mngh1.flatmusic.misc.SimpleObservableScrollViewCallbacks;
import com.mngh1.flatmusic.misc.WrappedAsyncTaskLoader;
import com.mngh1.flatmusic.model.Artist;
import com.mngh1.flatmusic.model.Song;
import com.mngh1.flatmusic.ui.activities.base.AbsSlidingMusicPanelActivity;
import com.mngh1.flatmusic.util.CustomArtistImageUtil;
import com.mngh1.flatmusic.util.MusicUtil;
import com.mngh1.flatmusic.util.NavigationUtil;
import com.mngh1.flatmusic.util.PhonographColorUtil;
...
public class ArtistDetailActivity extends AbsSlidingMusicPanelActivity implements SharedPreferences.OnSharedPreferenceChangeListener, PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Artist> {
    ...
    private void setUpBackground() {
        ...
        switch (bg) {
            case "them1":
                theme_artist.setBackgroundResource(R.drawable.bg1);
                break;
            case "them2":
                theme_artist.setBackgroundResource(R.drawable.bg2);
                break;
            case "them3":
                theme_artist.setBackgroundResource(R.drawable.bg3);
                break;
            case "them4":
                theme_artist.setBackgroundResource(R.drawable.bg4);
                break;
            case "them5":
                theme_artist.setBackgroundResource(R.drawable.bg5);
                break;
            case "them6":
                theme_artist.setBackgroundResource(R.drawable.bg6);
                break;
            case "them8":
                theme_artist.setBackgroundResource(R.drawable.bg8);
                break;
            case "them7":
                theme_artist.setBackgroundResource(R.drawable.bg7);
                break;
            case "them9":
                theme_artist.setBackgroundResource(R.drawable.bg9);
                break;
            case "them10":
                theme_artist.setBackgroundResource(R.drawable.bg10);
                break;
            case "them11":
                theme_artist.setBackgroundResource(R.drawable.bg11);
                break;
            default:
                theme_artist.setBackgroundResource(R.drawable.bg1);
                break;
